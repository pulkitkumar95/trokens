...
from trokens.models.common import drop_path
from trokens.models.nonlocal_helper import Nonlocal
from trokens.models.operators import SE, Swish
...
class ResStage(nn.Module):
    ...
    Stage of 3D ResNet. It expects to have one or more tensors as input for
        single pathway (C2D, I3D, Slow), and multi-pathway (trokens) cases.
        More details can be found here:

        Christoph Feichtenhofer, Haoqi Fan, Jitendra Malik, and Kaiming He.
        "trokens networks for video recognition."
