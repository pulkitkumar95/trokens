...
_C.MODEL.USE_CLS_TOKEN = True
_C.MODEL.USE_PATCH_AS_CLS = False
...
_C.DATA.REVERSE_INPUT_CHANNEL = True
...
# Path to the folder that contains the "dataset_splits" dir provided in "Something-Else"
_C.SSV2.SPLITS_ROOT = '../ORViT/data/ssv2'
...
_C.EPICKITCHENS.VISUAL_DATA_DIR = "Epic-kitchens-download-scripts-master/EPIC-KITCHENS"
...
_C.MODEL.ADAPOOLING = CfgNode()
_C.MODEL.ADAPOOLING.ENABLE = False
_C.MODEL.ADAPOOLING.TYPE = 'temporal_spatial'

# ---------------------------------------------------------------------------- #
# Newly-added Modify options
# ---------------------------------------------------------------------------- #
